...
import train_base.metrics as metrics
from train_base.acoustics.feature import stft, istft
from train_base.utils import prepare_empty_dir, ExecutionTime
    ...
    def metrics_visualization(self,
        ...
        for metric_name in metrics_list:
            ...
            if metric_name == "WB_PESQ":
                wb_pesq_mean = (mean_score_on_enhanced + 0.5) / 5
